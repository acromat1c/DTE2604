    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('itemType', models.CharField(choices=[('collectible', 'collectible'), ('other', 'other'), ('theme', 'theme'), ('title', 'title'), ('border', 'border')], max_length=1000)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('border', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='programmingCourse.item')),
                ('theme', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='programmingCourse.item')),
                ('title', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='programmingCourse.item')),
